...
- **🌐 English/German language toggle** – instant translation without page reload

## 🚀 Live Demo

[View the website](#) *(add your link here)*
...
The website includes a built-in language switcher that translates all visible content between English and German. Click the **🇩🇪 Deutsch** button in the navigation to switch languages – no page refresh required.
...
<body>
  ...
  <nav>
    ...
    <ul class="nav-links">
      ...
      <li><button id="lang-toggle" class="btn-outline" style="padding: 0.5rem 1.2rem; font-size: 0.75rem;">🇩🇪 Deutsch</button></li>
    </ul>
  </nav>
  ...
  <section id="gallery">
    ...
    <div class="gallery-grid">
      <div class="gallery-item tall">Classic Cut</div>
      <div class="gallery-item">Hot Towel</div>
      <div class="gallery-item">Beard Sculpt</div>
      <div class="gallery-item">Razor Finish</div>
      <div class="gallery-item">Style Studio</div>
    </div>
  </section>
  ...
  <section id="booking">
    <div>
      ...
      <div class="hours-block">
        ...
        <div class="hours-row"><span class="day">Tuesday</span><span>9:00 – 19:00</span></div>
        <div class="hours-row"><span class="day">Wednesday</span><span>9:00 – 19:00</span></div>
        <div class="hours-row"><span class="day">Thursday</span><span>9:00 – 19:00</span></div>
        <div class="hours-row"><span class="day">Friday</span><span>9:00 – 19:00</span></div>
  ...
  (function() {
    ...
    const translations = {
      en: {
        ...
        navGallery: 'Gallery',
        navBooking: 'Book Now',
        heroTag: 'Est. 2010 · Premium Grooming',
        heroTitle: 'Where Style<br>Meets <em>Craft</em>',
        heroSub: 'A refined experience for the modern gentleman. Expert cuts, classic shaves, and timeless grooming — all under one roof.',
        heroBtn1: 'Book Appointment',
        heroBtn2: 'View Services',
        heroScroll: 'Scroll',
        aboutLabel: 'Our Story',
        aboutTitle: 'More Than a Cut —<br><em>An Experience</em>',
        aboutText1: 'Founded in the heart of the city, The Golden Shear has been the destination for those who appreciate the art of grooming. Our master barbers bring decades of experience and passion to every chair.',
        aboutText2: 'We blend old-school barbering traditions with modern techniques to give you a look that\'s uniquely yours — every single visit.',
        stat1: 'Years Open',
        stat2: 'Expert Barbers',
        stat3: 'Avg. Rating',
        servicesLabel: 'What We Offer',
        servicesTitle: 'Our <em>Services</em>',
        service1Name: 'Classic Haircut',
        service1Desc: 'Precision cut tailored to your face shape and personal style. Includes wash and blow-dry.',
        service1Price: 'From €25',
        service2Name: 'Hot Towel Shave',
        service2Desc: 'The full traditional straight-razor shave with hot towel, pre-shave oil, and aftercare.',
        service2Price: 'From €30',
        service3Name: 'Cut & Shave Combo',
        service3Desc: 'The complete package — haircut plus a hot towel shave for the full gentleman experience.',
        service3Price: 'From €50',
        service4Name: 'Beard Trim & Shape',
        service4Desc: 'Expert beard sculpting, shaping, and conditioning. Leave looking sharp.',
        service4Price: 'From €18',
        service5Name: 'Scalp Treatment',
        service5Desc: 'Deep conditioning scalp massage and treatment for healthy, strong hair growth.',
        service5Price: 'From €35',
        service6Name: 'Kids Cut',
        service6Desc: 'Gentle, patient cuts for children under 12. A fun, stress-free experience for the whole family.',
        service6Price: 'From €15',
        ...
        bookingTitle: 'Book an<br><em>Appointment</em>',
        ...
        contactAddress: '123 Main Street, Frankfurt, Germany',
        contactPhone: '+49 69 123 456',
        contactEmail: 'hello@goldenshear.de',
      ...
      de: {
        ...
        heroTag: 'Gegr. 2010 · Premium-Pflege',
        heroTitle: 'Wo Stil<br>auf <em>Handwerk</em> trifft',
        heroSub: 'Ein exklusives Erlebnis für den modernen Gentleman. Professionelle Haarschnitte, klassische Rasur und zeitlose Pflege – alles unter einem Dach.',
        heroBtn1: 'Termin buchen',
        heroBtn2: 'Leistungen entdecken',
        heroScroll: 'Scrollen',
        aboutLabel: 'Unsere Geschichte',
        aboutTitle: 'Mehr als ein Schnitt —<br><em>Ein Erlebnis</em>',
        aboutText1: 'Gegründet im Herzen der Stadt, ist The Golden Shear der Ort für alle, die die Kunst der Körperpflege schätzen. Unsere Meisterfriseure bringen jahrzehntelange Erfahrung und Leidenschaft in jeden Stuhl.',
        aboutText2: 'Wir verbinden traditionelle Barbierkunst mit modernen Techniken, um Ihnen einen Look zu verleihen, der einzigartig ist – bei jedem Besuch.',
        stat1: 'Jahre geöffnet',
        stat2: 'Meisterfriseure',
        stat3: 'Durchschnittl. Bewertung',
        servicesLabel: 'Unsere Leistungen',
        servicesTitle: 'Unsere <em>Services</em>',
        service1Name: 'Klassischer Haarschnitt',
        service1Desc: 'Präziser Schnitt, angepasst an Ihre Gesichtsform und Ihren Stil. Inklusive Wäsche und Föhn.',
        service1Price: 'Ab 25€',
        service2Name: 'Heißrasur',
        service2Desc: 'Die traditionelle Rasiermesserrasur mit heißen Tüchern, Vorbereitungsöl und Pflege.',
        service2Price: 'Ab 30€',
        service3Name: 'Schnitt & Rasur Kombi',
        service3Desc: 'Das Komplettpaket – Haarschnitt plus Heißrasur für das vollständige Gentleman-Erlebnis.',
        service3Price: 'Ab 50€',
        service4Name: 'Barttrim & Formung',
        service4Desc: 'Professionelle Bartskulptur, Formung und Pflege. Verlassen Sie uns scharf aussehend.',
        service4Price: 'Ab 18€',
        service5
